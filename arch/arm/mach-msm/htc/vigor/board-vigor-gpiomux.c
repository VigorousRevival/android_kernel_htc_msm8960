...
static struct msm_gpiomux_config vigor_gsbi_configs[] __initdata = {
	{
		.gpio      = 44,		
		.settings = {
...
void __init vigor_init_gpiomux(void)
{
	int rc;
	...
	msm_gpiomux_install(vigor_gsbi_configs,
			ARRAY_SIZE(vigor_gsbi_configs));
}
