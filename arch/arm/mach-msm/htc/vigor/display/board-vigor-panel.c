/* linux/arch/arm/mach-msm/board-vigor-panel.c
 *
...
#ifdef CONFIG_FB_MSM_HDMI_MHL
static mhl_driving_params vigor_driving_params[] = {
...
#ifdef CONFIG_FB_MSM_HDMI_MHL
	.driving_params =  vigor_driving_params,
	.driving_params_count = ARRAY_SIZE(vigor_driving_params),
#endif
};
...
static struct platform_device mipi_dsi_vigor_panel_device = {
	.name = "mipi_vigor",
	.id = 0,
};
...
int mipi_cmd_vigor_qhd_pt_init(void);

void __init vigor_init_fb(void)
{
	msm8x60_set_display_params("mipi_vigor", "hdmi_msm");
	platform_device_register(&msm_fb_device);
	platform_device_register(&mipi_dsi_vigor_panel_device);
