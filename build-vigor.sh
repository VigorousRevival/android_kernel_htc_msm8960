...
export ARCH=arm
export CROSS_COMPILE=$HOME/Android/EvervolvLP/prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/arm-eabi-

## Build kernel using vigor_defconfig
